...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins my_pwm_ip_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net my_pwm_ip_0_PWM0 [get_bd_ports PWM0] [get_bd_pins my_pwm_ip_0/PWM0]
  connect_bd_net -net my_pwm_ip_0_PWM1 [get_bd_ports PWM1] [get_bd_pins my_pwm_ip_0/PWM1]
  connect_bd_net -net my_pwm_ip_0_PWM2 [get_bd_ports PWM2] [get_bd_pins my_pwm_ip_0/PWM2]
  connect_bd_net -net my_pwm_ip_0_PWM3 [get_bd_ports PWM3] [get_bd_pins my_pwm_ip_0/PWM3]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins my_pwm_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins my_pwm_ip_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_pwm_ip_0/S00_AXI/S00_AXI_reg] SEG_my_pwm_ip_0_S00_AXI_reg
...
preplace port PWM1 -pg 1 -y 190 -defaultsOSRD
preplace port PWM2 -pg 1 -y 210 -defaultsOSRD
preplace port PWM3 -pg 1 -y 230 -defaultsOSRD
preplace inst rst_processing_system7_0_50M -pg 1 -lvl 1 -y 350 -defaultsOSRD
preplace inst my_pwm_ip_0 -pg 1 -lvl 3 -y 200 -defaultsOSRD
...
preplace netloc my_pwm_ip_0_PWM0 1 3 1 NJ
preplace netloc my_pwm_ip_0_PWM1 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 260 410
preplace netloc my_pwm_ip_0_PWM2 1 3 1 NJ
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 1 2 440 300 740
preplace netloc my_pwm_ip_0_PWM3 1 3 1 NJ

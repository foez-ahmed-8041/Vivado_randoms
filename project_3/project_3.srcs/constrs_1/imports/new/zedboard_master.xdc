...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {PWM0}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {PWM1}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {PWM2}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {PWM3}];  # "LD3"

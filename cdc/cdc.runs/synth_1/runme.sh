...
HD_PWD='C:/Users/foeza/Desktop/vivado/cdc/cdc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeline_cdc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipeline_cdc.tcl

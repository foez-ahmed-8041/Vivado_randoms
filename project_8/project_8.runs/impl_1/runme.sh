...
HD_PWD='C:/Users/foeza/Desktop/vivado/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_core.tcl -notrace

...
HD_PWD='C:/Users/foeza/Desktop/vivado/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_core.tcl

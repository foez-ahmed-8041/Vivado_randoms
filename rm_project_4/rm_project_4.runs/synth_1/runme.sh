...
HD_PWD='C:/Users/foeza/Desktop/vivado/rm_project_4/rm_project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mx.tcl

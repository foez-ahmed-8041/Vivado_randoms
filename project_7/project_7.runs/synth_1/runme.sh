...
HD_PWD='C:/Users/foeza/Desktop/vivado/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log header_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source header_detector.tcl
